          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a aligh="center" class="btn btn-success" href="edit.php?ID=<?php echo $Result['ID']; ?>">EDIT</a>
                  <a aligh="center" class="btn btn-danger" href="delete.php?ID=<?php echo $Result['ID']; ?>">DELETE</a>
                </td>
              </tr>
            <?php
            }
